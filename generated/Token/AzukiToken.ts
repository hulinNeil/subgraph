...
export class AzukiToken__getOwnershipDataResultValue0Struct extends ethereum.Tuple {
  get addr(): Address {
...
export class AzukiToken__saleConfigResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class AzukiToken extends ethereum.SmartContract {
  static bind(address: Address): AzukiToken {
    return new AzukiToken("AzukiToken", address);
  }
  ...
  getOwnershipData(
    tokenId: BigInt
  ): AzukiToken__getOwnershipDataResultValue0Struct {
    let result = super.call(
      "getOwnershipData",
    ...
    return changetype<AzukiToken__getOwnershipDataResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getOwnershipData(
    tokenId: BigInt
  ): ethereum.CallResult<AzukiToken__getOwnershipDataResultValue0Struct> {
    let result = super.tryCall(
      "getOwnershipData",
      "getOwnershipData(uint256):((address,uint64))",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    ...
    return ethereum.CallResult.fromValue(
      changetype<AzukiToken__getOwnershipDataResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  saleConfig(): AzukiToken__saleConfigResult {
    let result = super.call(
      "saleConfig",
    ...
    return new AzukiToken__saleConfigResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_saleConfig(): ethereum.CallResult<AzukiToken__saleConfigResult> {
    let result = super.tryCall(
      "saleConfig",
      "saleConfig():(uint32,uint32,uint64,uint64,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new AzukiToken__saleConfigResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
